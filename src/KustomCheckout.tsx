...
// API Endpoint (Use the proxy path if calling Kustom directly from here, in real app this should be done on our server)
    ...
    <div>
      ...
      <div style={{ padding: '20px', border: '1px solid #ccc', marginBottom: '20px', borderRadius: '8px' }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between' }}>
          ...
          <span>{orderPayload.order_lines[0].unit_price / 100} SEK</span>
        </div>
        <hr />
        <div style={{ display: 'flex', justifyContent: 'space-between', fontWeight: 'bold' }}>
          <span>Total</span>
          <span>{orderPayload.order_lines[0].total_amount / 100} SEK</span>
        </div>
      </div>
